...
def get_teacher_issues(email):
  ...
  try:
    return app_tables.issues.search(reporter_email=email)
  except Exception as e:
    return []
...
def get_all_issues(filters=None):
  ...
  try:
    return app_tables.issues.search()
  except Exception as e:
    return []
...
def get_all_schools():
  ...
  try:
    ...
    return [(row, row['name']) for row in schools]
  except Exception as e:
    return []
...
def get_locations_by_school(school_id):
  ...
  try:
    ...
    return [(row, f"{row['branch']} - Floor {row['floor']} - {row['room']}") for row in locations]
  except Exception as e:
    return []
...
def get_pending_admins():
  ...
  try:
    return app_tables.users.search(role="admin", status="pending")
  except Exception as e:
    return []
